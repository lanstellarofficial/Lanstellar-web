    ...
    <div className="max-w-7xl mx-auto">
      <div className="text-center mb-16 space-y-4">
        ...
        <h2 className="text-3xl md:text-5xl font-medium font-helvetica text-black">
          ...
          <span className="text-[#5B1E9F] italic">mission</span>
        </h2>
      </div>
        ...
        {[
          {
            ...
            sup: "T",
            label:
              "Real-world assets trapped with no DeFi liquidity access globally",
            src: "BCG / WEF RWA Report",
          },
          {
            val: "$140",
            sup: "B+",
            label:
              "Stablecoins sitting idle in DeFi with no real-world economic yield",
            src: "DeFiLlama, 2024",
          },
          {
            val: "27",
            sup: "%+",
            label: "Average commercial lending rate for MFBs in Nigeria today",
            src: "CBN Monetary Policy, 2024",
          },
          {
            val: "41",
            sup: "M+",
            label: "Nigerian SMEs underserved by the current financial system",
            src: "SMEDAN / World Bank",
          },
        ].map((item, i) => (
          <div
            key={i}
            className="bg-white p-10 space-y-4 group hover:bg-gray-50 transition-colors"
          >
            <div className="text-4xl md:text-5xl font-helvetica font-medium">
              {item.val}
              <sup className="text-xl md:text-2xl text-[#5B1E9F] ml-1">
                {item.sup}
              </sup>
            </div>
            ...
            <div className="text-[9px] text-gray-300 uppercase tracking-widest pt-2">
              {item.src}
            </div>
          </div>
        ))}
...
const Waitlist = () => {
  ...
  return (
    <>
      ...
      <section
        id="waitlist"
        className="w-full bg-[#151515] font-inter text-white pb-24"
      >
        <div className="mx-auto w-full max-w-7xl px-6 md:px-12 py-24">
          <div className="max-w-3xl mx-auto text-center space-y-6 mb-16">
            ...
            <h2 className="text-3xl md:text-5xl font-medium font-helvetica leading-tight">
              Be part of{" "}
              <span className="text-[#5B1E9F] italic">
